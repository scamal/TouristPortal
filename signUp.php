...
<div class="container-fluid" id="container">
    <div class="row">
        ...
        <div  class="jumbotron col-md-5 " id="sign">
            <h1 class="text-center" id="title">Lost & found</h1>
            <form action="index2.php" method="get"> <!--onsubmit="return submit_function(this)"-->
                ...
                <label for="Phone_number" >Phone number:</label><br><input type="tel" class="conditional" id="Phone_number" name="Phone_number"placeholder="optional" onblur="check(this)"><div id="Phone_numberdiv"></div><br><br>
